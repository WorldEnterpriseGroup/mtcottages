...
NAV_DESKTOP = """<ul class="nav_scroll">
                ...
                <li><a class="mdy-hover" href="services.html">Services <i class="fas fa-angle-down"></i></a>
                  <ul class="sub-menu">
                    ...
                    <li><a href="services.html#meal-preparation">Optional Meal Preparation</a></li>
...
def common_replacements(text: str, page: str) -> str:
    ...
    text = text.replace('Furnished places for real life, supported by a small hospitality team. \n                      before sticky communities. Assertively matrix multif\n                      sources through team building', 'Furnished places for real life, supported by a small hospitality team.')
